...
(function(){
	...
	if(supportsES) {
		...
		asyncTest("basics with generated html", function(){
			writeIframe(makeStealHTML(
				"basics/basics.html",
				'src="../../steal.js?main=basics" data-config="../config.js"'));
		});

		asyncTest("default config path", function(){
			writeIframe(makeStealHTML(
				"basics/basics.html",
				'src="../steal.js?main=basics"'));
		});

		asyncTest("default config path", function(){
			writeIframe(makeStealHTML(
				"basics/basics.html",
				'src="../steal/steal.js?main=basics"'));
		});
	...
	if(supportsES) {
		asyncTest("default bower_components config path", function(){
			writeIframe(makeStealHTML(
				"basics/basics.html",
				'src="../bower_components/steal/steal.js?main=basics"'));
		});
	...
	if(supportsES) {
		asyncTest("read config", function(){
			writeIframe(makeStealHTML(
				"basics/basics.html",
				'src="../../steal.js?main=configed" data-config="../config.js"'));
		});
	}
