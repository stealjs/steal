...
var oldProto = steal.URI.prototype
  , oldAddJS = oldProto.addJS
  , oldNormalize = oldProto.normalize;
...
extend(steal.URI.prototype, {
	addJS: function(){
		// We need to attach the actual name so we can try to
		// require it in Node.
		var name = this+"";
		oldAddJS.apply(this, arguments);
		this.name = name;
		return this;
	},
	normalize: function(){
		var name = this.name;
		var res = oldNormalize.apply(this, arguments);
		res.name = name;
		return res;
	},
	mkdir: function () {
