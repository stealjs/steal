		...
		makeOptions : function(options){
			...
			if ( ! ext ) {
				...
				// else, load as a plugin
					...
					src.parts.path += "/" + src.filename() + ".js";
				}
			}
...
steal.type("fn", function(options, success) {
	success(options.fn());
});
...
steal.type("css", function(options, success, error) {
